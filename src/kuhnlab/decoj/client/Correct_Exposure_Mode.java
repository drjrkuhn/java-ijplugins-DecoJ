...
public class Correct_Exposure_Mode implements PlugInFilter {
    ...
    public int setup(String arg, ImagePlus imp) {
        ...
        if (imp.getStackSize() <= 1) {
            IJ.showMessage("Correct Exposure Mode", "This filter must be used on a stack");
            return DONE;
        }
    ...
    public void run(ImageProcessor ip) {
        ...
        int measurements = Measurements.MEAN + Measurements.MODE;
        ...
        for (z=0; z<d; z++) {
            ...
            adBackground[z] = stats.dmode;
            if (stats.dmode > dMax)
                dMax = stats.dmode;
        }
        //IJ.write("Max mode = "+dMax);
        ...
        if (impSrc.getType() == ImagePlus.GRAY16) {
            ...
            for (z=0; z<d; z++) {
                ...
                //IJ.write(""+(z+1)+" mode="+IJ.d2s(adBackground[z],2)+" max="+IJ.d2s(dMax,2));
